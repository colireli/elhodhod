    ...
    Route::group(
        ...
        Route::middleware('auth')->prefix(env('PREFIX_ADMIN', 'admin'))->group(function() {
            ...
            Route::prefix('shipment-team')->group(function() {
                ...
                //  START_CODE
                //ApiModel
                Route::get('/apimodels', 'ApiModelController@index')->name('admin.apimodel.index');
                Route::get('/apimodel/{id}/show', 'ApiModelController@show')->name('admin.apimodel.show');
                Route::get('/apimodel/create', 'ApiModelController@create')->name('admin.apimodel.create');
                Route::post('/apimodel/update', 'ApiModelController@update')->name('admin.apimodel.update');
                Route::post('/apimodel/store', 'ApiModelController@store')->name('admin.apimodel.store');
                Route::get('/apimodel/{id}/edit', 'ApiModelController@edit')->name('admin.apimodel.edit');
                Route::get('/apimodel/destroy', 'ApiModelController@destroy')->name('admin.apimodel.destroy');

                Route::get('/plan/getBranchPlan', 'PlanController@getBranchPlan')->name('admin.plan.get-branch-plan');
                Route::get('/plan/getBranchcompany', 'PlanController@getBranchcompany')->name('admin.plan.get-branch-company');
                //Company

                Route::get('/companies', 'CompanyController@index')->name('admin.company.index');
                Route::get('/company/{id}/show', 'CompanyController@show')->name('admin.company.show');
                ...
                Route::get('/company/{id}/edit', 'CompanyController@edit')->name('admin.company.edit');
                ...
                Route::get('/company/{id}/showFees', 'CompanyController@showFees')->name('admin.company.showfees');
                Route::get('/company/getCompanyPlan', 'CompanyController@getCompanyPlan')->name('admin.company.get-company-plan');
                ...
                Route::get('/plan-getStopDesk', 'PlanController@getStopDesk')->name('admin.plan.getStopDesk');

                // Route::get('get-states-ajax', 'CompanyPlanController@getStates')->name('admin.shipments.get-states-ajax');

                //RapPayment
                Route::get('shipments-import-delivery', 'RapPayController@importDelivery')->name('admin.rappayment.import_delivery');
                Route::get('shipments-import-payment', 'RapPayController@importPayment')->name('admin.rappayment.import_payment');
                Route::get('uploaded-payments', 'RapPayController@uploadedPayments')->name('admin.rappayment.imported_payment');
                Route::get('pdf-uploaded-payments/{payment}', 'RapPayController@pdfPayment')->name('admin.rappayment.imported_payment.downpdf');
                Route::get('xls-uploaded-payments/{payment}', 'RapPayController@xlsPayment')->name('admin.rappayment.imported_payment.downxls');
                Route::post('shipments-import-case', 'RapPayController@importCase')->name('admin.rappayment.import_case');
                Route::post('shipments-import-pay-sub', 'RapPayController@importPaymentSub')->name('admin.rappayment.import_payment_sub');
                Route::get('pdf-client-payments/{payment}', 'RapPayController@pdfPaymentClient')->name('admin.rappayment.client_payments.downpdf');
                Route::get('xls-client-payments/{payment}', 'RapPayController@xlsPaymentClient')->name('admin.rappayment.client_payments.downxls');
                Route::post('picked-client-payments/{payment}', 'RapPayController@picked')->name('admin.rappayment.client_payments.picked');
                Route::get('picked-client-payments-get/{payment}', 'RapPayController@getPicked')->name('admin.rappayment.client_payments.getpicked');

                Route::resource('payment_client', 'RapPayController', ['as' => 'admin']);

                //Branch
                Route::get('/branchsLogin/{id}', 'BranchController@loginBranch')->name('branchs.login');
                // END_CODE
                ...
                Route::get('/clientsLogin/{id}', 'ClientController@loginClient')->name('clients.login');
            ...
            Route::prefix('shipments')->group(function() {
                ...
                Route::post('import', 'ShipmentController@parseImport')->name('shipments.import_parse');
                ...
                Route::post('shipments/getFinalStatutExternColi','ShipmentController@getFinalStatutExternColi')->name('shipments.action.getFinalStatutExternColi');


                // Shipment Routes
                Route::get('report','ShipmentController@shipmentsReport')->name('shipments.report');
                Route::get('client-payments/{client}', 'RapPayController@clientPayments')->name('shipments.rappayment.client_payments');
