...
class Shipment extends Model implements HasMedia
{
    ...
    static public function status_info()
    {
        $array = [
            [
                ...
                'text' => __('Draft'),
                'route_name' => 'admin.shipments.draft.index',
            ...
            [
                ...
                'text' => __('Alert'),
                'route_name' => 'admin.shipments.alert.deliverd.index',
                'permissions' => 'approved-shipments',
                'route_url' => 'alert-deliverd'
            ],
    ...
    static public function final_status_info()
    {
        $array = [
            [
                'status' => 0,
    ...
    {
        $result = null;
        foreach (Self::final_status_info() as $status) {
            $status_id = $this->final_status;
            $result = (isset($status['status']) && $status['status'] == $status_id) ? $status['text'] : null;
            if ($result != null) {
                return $result;
            }
