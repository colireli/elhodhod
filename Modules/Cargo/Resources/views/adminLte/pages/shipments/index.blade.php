    ...
    <div class="card">
        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-toolbar">
                ...
                <!--end::Toolbar-->
                @if(isset($status) && $status == Modules\Cargo\Entities\Shipment::DRAFT_STATUS)
                        <button onclick="openDeleteModel('kt_form_2')" class="btn btn-danger me-2">{{__('Delete')}}</button>
                        <form action="{{ fr_route('shipments.multi-destroy') }}" id="kt_form_2" method="post" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('delete')
                ...
                <!--begin::More actions -->
                        ...
                        <button onclick="submitForm('kt_form_1')" class="btn btn-light-info me-2">{{__('Update Status')}}</button>
                        <form action="{{ fr_route('shipments.action.getFinalStatutExternColi') }}" id="kt_form_1" method="post" enctype="multipart/form-data" novalidate>
                            @csrf
                            <input type="hidden" name="checked_ids" class="checked_ids" />
                        </form>
...
@section('scripts')
    ...
    <script>
        ...
        function openDeleteModel(formId)
    {
            Swal.fire({
                    icon: 'error',
