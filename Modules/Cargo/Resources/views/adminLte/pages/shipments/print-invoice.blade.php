                            ...
                            <div class="px-0 d-flex flex-column align-items-md-end">
                                ...
                                <a href="#">
                                    @if($shipment->barcode != null)
                                        <img src="data:image/png;base64, <?=$d->getBarcodePNG($shipment->code, 'C128');?> " alt="barcode"   />
                                    @endif
                                </a>
                                @if($shipment->track != null)
                                <br>
                                <a href="#">
                                        <img src="data:image/png;base64, <?=$d->getBarcodePNG($shipment->track, 'C128');?> " alt="tracking"   />
                                </a>
                                @endif
                                <!--end::Logo-->
