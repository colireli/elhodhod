    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header">
            ...
            <div class="card-title m-0">
                ...
                <h4><a href="@if($user_role == $admin || $user_role == $branch)
                                    {{ route('clients.login', encrypt($model->id)) }}
                                    @else
                                    #
        ...
        <div class="card-body p-9">
                ...
                <div class="row mb-7">
                    <!--begin::Label-->
                    <label class="col-lg-4 fw-bold text-muted">{{ __('Plan') }}</label>
                    <!--end::Label-->
                    <!--begin::Col-->
                    <div class="col-lg-8">
                    <span class="fw-bolder fs-6 text-gray-800">{{ $model->plan->title }}</span>
                    </div>
                    <!--end::Col-->
                </div>
                <!--end::Row-->
