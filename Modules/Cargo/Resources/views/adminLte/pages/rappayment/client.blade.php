...
<div id="ajax-model" class="modal fade">
        ...
        <table class="table mb-0 aiz-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $payment->ip }}</td>
                    <td>{{ $payment->picked ? __('PICKED') : __('PENDING') }}</td>
                    ...
                    @if (auth()->user()->role == 4)
                        <td>
                            ...
                            @else
                                ...
                                <button class="btn btn-primary" onclick="openAjaxModel('{{ route('admin.rappayment.client_payments.getpicked', $payment->id) }}')">{{ __('Click To Pick') }}</button>
                    ...
                    <td class="text-center">
                        ...
                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                            href="{{route('admin.rappayment.client_payments.downxls', $payment->id)}}"
                            title="{{ __('XLS File') }}">
                            <i class="las la-file-alt"></i>
                        </a>
                        <a class="btn btn-soft-primary btn-icon btn-circle btn-sm"
                            href="{{route('admin.rappayment.client_payments.downpdf', $payment->id)}}"
                            title="{{ __('PDF File') }}">
...
<script type="text/javascript">
    ...
    function openAjaxModel(url)
    {
        ...
        $.ajax({
            ...
            $('#ajax-model .modal-content').html(response);
            // Display Modal
